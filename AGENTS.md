...
- Twenty-three independently written C functions now match their original ranges:
  ...
  `src/boot/boot_resource_record_resolve_load.c` (524 bytes),
  `src/overlays/descriptor_12/func_00269470.c` (808 bytes),
  `src/overlays/descriptor_12/func_0026B360.c` (1,156 bytes),
  ...
  `src/lib/list_insert_head_000241f8.c` (88 bytes),
  `src/lib/func_0025CB60.c` (72 bytes), and
  `src/lib/func_0025EFC8.c` (144 bytes).
