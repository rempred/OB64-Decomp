...
- Tracked real-assembler original-MIPS chunks: 1 composite
  (`0x00001000..0x00011000`) made from 95 real-assembler source files.
...
- Current remainder:
  `asm/original/rev0/code_0000A29C_00011000.s`.
...
`0xA29C`; it is an 88-byte recursive child/free helper and should be the next
source split target.
...
- Current verifier result: PASS; 825 archives, 0 unknown bytes, 108 overlap
  bytes visible, 1 tracked composite real-asm chunk made from 95 tracked source
...
tracked original-MIPS splits from `asm/original/rev0/code_0000A29C_00011000.s`.
The next MIPS frontier starts with `0xA29C`, an 88-byte recursive child/free
helper with frame size `0x18`, callers from `0x9A18`, `0x9A28`, `0xA198`,
`0xA250`, and itself, two self-recursive calls, and two calls to `resource_free`
`0x16C4`; local source recurses through `+0x10/+0x14`, writes returned values
into those fields, frees `+0x04`, frees the node, and returns zero. Do not begin
