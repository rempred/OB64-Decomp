...
- Tracked real-assembler original-MIPS chunks: 79 composites (chunk 0 177 `boot/`;
  chunks 1–78 in `lib/`: 350, 216, 67, 376, 88, 78, 103, 87, 34, 35, 191, 74, 67, 94, 153, 95, 66, 95, 80, 175, 99, 99, 73, 63, 71, 96, 142, 97, 103, 122, 86, 198, 109, 120, 134, 164, 180, 232, 155, 159, 160, 171, 90, 17, 15, 17, 27, 9, 11, 13, 13, 13, 9, 9, 9, 7, 1, 5, 3, 3, 5, 5, 5, 7, 15, 8, 21, 33, 23, 19, 23, 21, 33, 13, 7, 7, 15, 4) = 6,069 real-assembler
  source files. Chunks 0–78 (`0x00001000..0x004F1000`) are now fully source-owned as
  named code/data parts (chunks 66-77 = the chunk-66/67 N64 audio bank + flat Section A audio, all AUDIO;
  chunk 78 crosses the **Section A/B boundary** [pinned 0x4E3140]: Section A audio tail + Section B index
  table [1798 records, shape decoded] + Section B payload [undecoded] + first parser-backed cutscene-block
  head [tag 0x215]; chunk-78 bytes owned, Section B unit partial; Section A 0x301000..0x4E3140 fully AUDIO) (chunks 62-65 = Section A slice 3 [0x3E1000..0x421000]: 0 code + 32 data
  ...
  next is chunk 79 (`0x004F1000`, still a
  generated fallback chunk — Section B cutscene anim-block family, parser-backed).
- Generated fallback chunks: 21.
...
- Current verifier result: PASS; 825 archives, 0 unknown bytes, 108 overlap
  bytes visible, 79 tracked composite real-asm chunks made from 6,069 tracked source
  files (chunks 0–78 fully source-owned as code/data parts, `0x00001000..0x004F1000`),
  21 generated fallback chunks, full-source manifest 1,059 entries with
