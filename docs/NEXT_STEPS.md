...
(`0x00001000..0x00011000`) made from 15 tracked source files, plus 99 generated
fallback chunks.
...
3. Continue splitting the first tracked chunk into smaller source files.
   ...
   The boot entry, first resource/arena split, allocator/free split, and
   validation/realloc/tree-helper split are done. Continue from
