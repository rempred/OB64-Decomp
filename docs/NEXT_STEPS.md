...
(`0x00001000..0x00011000`) made from 31 tracked source files, plus 99 generated
fallback chunks.
...
3. Continue splitting the first tracked chunk into smaller source files.
   ...
   display-list counter-step split are done. Continue from
   `asm/original/rev0/code_000040B0_00011000.s`, beginning with the
   `0x000040B0` prologue helper.
