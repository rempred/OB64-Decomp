...
3. Continue splitting the first tracked chunk into smaller source files.
   ...
   copy/flag split are done. Continue from
   `asm/original/rev0/code_00005C58_00011000.s`, beginning with the overlapping
   `0x5C58/0x5C60` large-record copy/flag helper family.
