...
coverage. Current expected result: 46 tracked composite real-asm chunks made from
5,656 tracked source files (chunks 0–45 fully source-owned, `0x00001000..0x002E1000`), plus 55
