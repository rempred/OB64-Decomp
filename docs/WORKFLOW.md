...
coverage. Current expected result: 26 tracked composite real-asm chunks made from
3,106 tracked source files (chunks 0–25 fully source-owned, `0x00001000..0x001A1000`), plus 74
