...
coverage. Current expected result: 78 tracked composite real-asm chunks made from
6,065 tracked source files (chunks 0–77 fully source-owned, `0x00001000..0x004E1000`), plus 22
