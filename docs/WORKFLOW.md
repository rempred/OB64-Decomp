...
coverage. Current expected result: 62 tracked composite real-asm chunks made from
5,810 tracked source files (chunks 0–61 fully source-owned, `0x00001000..0x003E1000`), plus 38
