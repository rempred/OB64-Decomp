...
coverage. Current expected result: 28 tracked composite real-asm chunks made from
3,441 tracked source files (chunks 0–28 fully source-owned, `0x00001000..0x001D1000`), plus 71
