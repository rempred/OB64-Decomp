...
coverage. Current expected result: 15 tracked composite real-asm chunks made from
2,037 tracked source files (chunks 0–14 fully source-owned, `0x00001000..0x000F1000`), plus 85
