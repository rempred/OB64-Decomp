...
coverage. Current expected result: 36 tracked composite real-asm chunks made from
4,313 tracked source files (chunks 0–35 fully source-owned, `0x00001000..0x00241000`), plus 64
