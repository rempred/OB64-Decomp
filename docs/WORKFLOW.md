...
coverage. Current expected result: 9 tracked composite real-asm chunks made from
1,542 tracked source files (chunks 0–8 fully source-owned, `0x00001000..0x00091000`), plus 91
