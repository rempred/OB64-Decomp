...
coverage. Current expected result: 25 tracked composite real-asm chunks made from
3,035 tracked source files (chunks 0–24 fully source-owned, `0x00001000..0x00191000`), plus 75
