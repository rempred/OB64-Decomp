...
coverage. Current expected result: 20 tracked composite real-asm chunks made from
2,526 tracked source files (chunks 0–19 fully source-owned, `0x00001000..0x00141000`), plus 80
