...
coverage. Current expected result: 47 tracked composite real-asm chunks made from
5,673 tracked source files (chunks 0–46 fully source-owned, `0x00001000..0x002F1000`), plus 55
