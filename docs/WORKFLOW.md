...
coverage. Current expected result: 41 tracked composite real-asm chunks made from
5,203 tracked source files (chunks 0–40 fully source-owned, `0x00001000..0x00281000`), plus 59
