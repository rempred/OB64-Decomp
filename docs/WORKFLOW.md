...
coverage. Current expected result: 10 tracked composite real-asm chunks made from
1,576 tracked source files (chunks 0–9 fully source-owned, `0x00001000..0x000A1000`), plus 90
