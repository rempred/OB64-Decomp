...
coverage. Current expected result: 32 tracked composite real-asm chunks made from
3,752 tracked source files (chunks 0–31 fully source-owned, `0x00001000..0x00201000`), plus 68
