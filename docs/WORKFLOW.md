...
coverage. Current expected result: 66 tracked composite real-asm chunks made from
5,842 tracked source files (chunks 0–65 fully source-owned, `0x00001000..0x00421000`), plus 34
