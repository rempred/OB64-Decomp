...
coverage. Current expected result: 31 tracked composite real-asm chunks made from
3,666 tracked source files (chunks 0–30 fully source-owned, `0x00001000..0x001F1000`), plus 69
