...
coverage. Current expected result: 67 tracked composite real-asm chunks made from
5,850 tracked source files (chunks 0–66 fully source-owned, `0x00001000..0x00431000`), plus 33
