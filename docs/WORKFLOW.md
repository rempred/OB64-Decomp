...
coverage. Current expected result: 38 tracked composite real-asm chunks made from
4,657 tracked source files (chunks 0–37 fully source-owned, `0x00001000..0x00261000`), plus 62
