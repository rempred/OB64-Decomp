...
coverage. Current expected result: 21 tracked composite real-asm chunks made from
2,701 tracked source files (chunks 0–20 fully source-owned, `0x00001000..0x00151000`), plus 79
