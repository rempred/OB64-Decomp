...
coverage. Current expected result: 79 tracked composite real-asm chunks made from
6,069 tracked source files (chunks 0–78 fully source-owned, `0x00001000..0x004F1000`), plus 21
