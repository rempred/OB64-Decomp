...
coverage. Current expected result: 40 tracked composite real-asm chunks made from
5,044 tracked source files (chunks 0–39 fully source-owned, `0x00001000..0x00281000`), plus 60
