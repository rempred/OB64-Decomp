...
coverage. Current expected result: 89 tracked composite real-asm chunks made from
6,140 tracked source files (chunks 0–88 fully source-owned, `0x00001000..0x00591000`), plus 11
