...
coverage. Current expected result: 68 tracked composite real-asm chunks made from
5,871 tracked source files (chunks 0–67 fully source-owned, `0x00001000..0x00441000`), plus 32
