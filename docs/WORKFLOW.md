...
coverage. Current expected result: 39 tracked composite real-asm chunks made from
4,889 tracked source files (chunks 0–38 fully source-owned, `0x00001000..0x00271000`), plus 61
