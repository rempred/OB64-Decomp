...
coverage. Current expected result: 22 tracked composite real-asm chunks made from
2,800 tracked source files (chunks 0–21 fully source-owned, `0x00001000..0x00161000`), plus 78
