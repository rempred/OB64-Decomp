...
coverage. Current expected result: 19 tracked composite real-asm chunks made from
2,446 tracked source files (chunks 0–18 fully source-owned, `0x00001000..0x00131000`), plus 81
