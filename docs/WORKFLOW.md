...
coverage. Current expected result: 23 tracked composite real-asm chunks made from
2,899 tracked source files (chunks 0–22 fully source-owned, `0x00001000..0x00171000`), plus 77
