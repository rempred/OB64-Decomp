...
coverage. Current expected result: 27 tracked composite real-asm chunks made from
3,202 tracked source files (chunks 0–26 fully source-owned, `0x00001000..0x001B1000`), plus 73
