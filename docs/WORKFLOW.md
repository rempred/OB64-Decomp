...
coverage. Current expected result: 11 tracked composite real-asm chunks made from
1,611 tracked source files (chunks 0–10 fully source-owned, `0x00001000..0x000B1000`), plus 89
