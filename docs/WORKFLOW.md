...
coverage. Current expected result: 14 tracked composite real-asm chunks made from
1,943 tracked source files (chunks 0–13 fully source-owned, `0x00001000..0x000E1000`), plus 86
