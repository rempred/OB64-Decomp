...
coverage. Current expected result: 8 tracked composite real-asm chunks made from
1,455 tracked source files (chunks 0–7 fully source-owned, `0x00001000..0x00081000`), plus 92
