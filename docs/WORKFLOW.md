...
coverage. Current expected result: 42 tracked composite real-asm chunks made from
5,363 tracked source files (chunks 0–41 fully source-owned, `0x00001000..0x00281000`), plus 58
