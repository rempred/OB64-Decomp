...
coverage. Current expected result: 48 tracked composite real-asm chunks made from
5,700 tracked source files (chunks 0–47 fully source-owned, `0x00001000..0x00301000`), plus 55
