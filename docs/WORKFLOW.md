...
coverage. Current expected result: 18 tracked composite real-asm chunks made from
2,351 tracked source files (chunks 0–17 fully source-owned, `0x00001000..0x00121000`), plus 82
