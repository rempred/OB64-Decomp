...
coverage. Current expected result: 3 tracked composite real-asm chunks made from
743 tracked source files (chunks 0, 1 and 2 fully named, `0x00001000..0x00031000`), plus 97
