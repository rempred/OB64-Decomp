...
coverage. Current expected result: 52 tracked composite real-asm chunks made from
5,746 tracked source files (chunks 0–51 fully source-owned, `0x00001000..0x00341000`), plus 48
