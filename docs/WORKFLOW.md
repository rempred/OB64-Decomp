...
coverage. Current expected result: 16 tracked composite real-asm chunks made from
2,190 tracked source files (chunks 0–15 fully source-owned, `0x00001000..0x00101000`), plus 84
