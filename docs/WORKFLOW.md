...
coverage. Current expected result: 24 tracked composite real-asm chunks made from
2,972 tracked source files (chunks 0–23 fully source-owned, `0x00001000..0x00181000`), plus 76
