...
- Current remainder: `code_0000B030_00011000.s`.
...
Continue from `asm/original/rev0/code_0000B030_00011000.s`. The next target is
the parent-labeled resource-loader helper at `0xB030..0xB0B0`, frame size
`0x20`, fixed RAM `0x8007AC30`, with calls to RAM `0x800936E0`, LZSS
decompressor RAM `0x8007A110`, RAM `0x80093810`, and unresolved RAM helper
`0x80093540`. Its local source walks records from `0x800AF320`, calls LZSS when
