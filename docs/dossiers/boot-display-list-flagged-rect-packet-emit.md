...
| `asm/original/rev0/code_0000906C_00011000.s` | `0x0000906C..0x00011000` | `0x80078C6C..0x80080C00` | Remainder at this split; now superseded by `code_00009A18_00011000.s` after later display-list and command-stream splits. |
...
- The next parent boundary at `0x0000906C` begins a separate 956-byte prologue
  ...
  transform coefficients plus command-stream splits now leave
  `code_00009A18_00011000.s` as the active remainder.
