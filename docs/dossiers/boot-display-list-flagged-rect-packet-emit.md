...
| `asm/original/rev0/code_0000906C_00011000.s` | `0x0000906C..0x00011000` | `0x80078C6C..0x80080C00` | Current tracked remainder; starts at the `0x906C` display-list helper. |
...
- The next parent boundary at `0x0000906C` begins a separate 956-byte prologue
  ...
  unresolved RAM target `0x8007338C`. Keep that next helper separate until its
  larger packet path is analyzed.
