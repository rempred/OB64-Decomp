...
| `asm/original/rev0/code_000068E0_00011000.s` | `0x000068E0..0x00011000` | `0x800764E0..0x80080C00` | Remainder after the resource table/mask apply split; now superseded by the boot state global reset split. |
