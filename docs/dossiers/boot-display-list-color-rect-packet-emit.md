...
| `asm/original/rev0/code_00009428_00011000.s` | `0x00009428..0x00011000` | `0x80079028..0x80080C00` | Current tracked remainder; starts at a secondary-entry-bearing helper. |
...
- Keep the `0x9428` family together until the secondary entries and tail prefix
  before `0x954C` are understood.
