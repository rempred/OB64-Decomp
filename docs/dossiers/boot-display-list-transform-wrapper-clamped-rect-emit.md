...
| `asm/original/rev0/code_00008D6C_00011000.s` | `0x00008D6C..0x00011000` | `0x8007896C..0x80080C00` | Remainder at this split; now superseded by `code_00009428_00011000.s` after the flagged and color rect packet splits. |
...
- The split ends at `0x00008D6C`, where parent data records the next valid
  ...
  packet split now leaves `code_00009428_00011000.s` as the active remainder.
