...
| `asm/original/rev0/code_00008D6C_00011000.s` | `0x00008D6C..0x00011000` | `0x8007896C..0x80080C00` | Remainder at this split; now superseded by `code_0000954C_00011000.s` after the flagged rect, color rect, and vector distance/transform-prefix splits. |
...
- The split ends at `0x00008D6C`, where parent data records the next valid
  ...
  `boot_display_list_flagged_rect_packet_emit.s`; the follow-up color rect
  packet split and follow-up vector distance/transform-prefix split now leave
  `code_0000954C_00011000.s` as the active remainder.
