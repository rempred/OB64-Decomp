...
| `asm/original/rev0/code_00004AC8_00011000.s` | `0x00004AC8..0x00011000` | `0x800746C8..0x80080C00` | Historical next tracked remainder; superseded by `boot_resource_probe_init.s`, `boot_resource_probe_finalize.s`, `boot_resource_probe_dispatch_prepare.s`, `boot_resource_probe_dispatch_apply.s`, and `code_00004ED4_00011000.s`. |
...
- The active remainder at this step started at the next parent prologue boundary
  `0x00004AC8`; follow-up splits now cover `0x00004AC8..0x00004ED4`, so the
  active remainder starts at `0x00004ED4`.
