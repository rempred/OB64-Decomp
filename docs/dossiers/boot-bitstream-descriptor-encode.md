...
| `asm/original/rev0/code_00004AC8_00011000.s` | `0x00004AC8..0x00011000` | `0x800746C8..0x80080C00` | Historical next tracked remainder; superseded by the resource-probe splits through `boot_resource_probe_dispatch_result_build.s` and `code_00004FF0_00011000.s`. |
...
- The active remainder at this step started at the next parent prologue boundary
  `0x00004AC8`; follow-up splits now cover `0x00004AC8..0x00004FF0`, so the
  active remainder starts at `0x00004FF0`.
