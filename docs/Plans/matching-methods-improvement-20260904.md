...
| Editor startup and export structure | Astra; startup assignment ready | Measure startup and ROM initialization, then defer justified dataset loading. Use Editor main at starting commit `e8c2759`, preserving the accepted recovery worktrees. Parent assignment: `docs/Plans/prompts/editor-startup-loading-r1.md`. Extract one coherent export responsibility after startup acceptance. |
