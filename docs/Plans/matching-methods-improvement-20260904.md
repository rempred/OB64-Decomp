...
| Editor startup and export structure | Astra; startup independent review active | Editor result `c8a3a18` defers two revision 0 datasets. Worker measurements report faster empty-page and combined startup/ROM paths, with slower ROM initialization alone. Parent review: `docs/Plans/prompts/editor-startup-loading-review-r1.md`. Preserve the accepted recovery worktrees. Extract one coherent export responsibility after startup acceptance. |
