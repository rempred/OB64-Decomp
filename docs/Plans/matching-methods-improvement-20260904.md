...
| Editor export structure | Astra; assignment ready | Extract one coherent ROM-export responsibility from `app.js`, preserving output bytes and user behavior. Start from Editor main `30bec4d`, preserving the accepted recovery worktrees. Parent assignment: `docs/Plans/prompts/editor-export-structure-r1.md`. |
