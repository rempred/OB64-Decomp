...
4. Combat W5 continues under R2 after the requested GUI work. Tooling 03063b4 is Accepted by review b30a6c5; GUI launch is recorded at f40eec6. Combat is selected and has no capture time limit. R1's inactive candidate and native-object evidence remain preserved; all eight pending targets and twelve total members remain required. Accepted discovery at parent `e445991` adds seven inclusions and five shared integrations; parent `f940a28` closes only the fixed-image gate at static scope. Selector consumer provenance remains unresolved.
