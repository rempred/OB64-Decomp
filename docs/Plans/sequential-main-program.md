...
4. Combat remaining source waves: pending. Accepted discovery and citation CR-1 are propagated at parent `e445991`, adding seven inclusions and five shared integrations as supplemental source obligations. Discovery r2 is Accepted: the attack-label image-service exclusion can close the fixed-image gate after propagation. Selector consumer provenance remains unresolved; Astra observation preparation is active on the separate completed runtime retrieval.
