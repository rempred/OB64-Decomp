...
4. Combat W5 resumes under R3 from ddf86c9 after Joe deferred resolver capture tonight. The activated five-member group and record loader have provisional exact PURE_C linked evidence; four standalone targets remain, and all twelve members retain one final gate. Resolver R4 preserves diagnosis of the zero-stack parser defect and residual-queue recovery limits for later correction; no live recovery or new capture is authorized. Capture has no duration limit. Accepted discovery at parent `e445991` adds seven inclusions and five shared integrations; parent `f940a28` closes only the fixed-image gate at static scope. Selector consumer provenance remains unresolved.
