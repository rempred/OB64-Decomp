...
4. Combat W5 R2 is paused safely at ddf86c9 for Joe's observed Combat capture startup error. Its activated five-member group and record loader have provisional exact PURE_C linked evidence; four standalone targets remain, and the complete twelve-member final gate is pending. R4 diagnosis identified zero-stack command parsing as a runtime compatibility defect missed by earlier offline tests. Capture has no duration limit. Preserve GUI/review history at f40eec6/b30a6c5 and resume complete W5 after the focused correction. Accepted discovery at parent `e445991` adds seven inclusions and five shared integrations; parent `f940a28` closes only the fixed-image gate at static scope. Selector consumer provenance remains unresolved.
