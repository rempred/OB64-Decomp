# Archived DECOMP_LOG narratives — boot subsystems + chunks 1–7

Moved out of `docs/DECOMP_LOG.md` on 2026-06-22 (during the chunks 10–11 run) to keep
the running log lean. These are the detailed per-split narratives for the boot
subsystems (`0xB030..0x11000`) and chunks 1–7 (`0x11000..0x81000`). Durable findings
also live in the per-chunk dossiers and review handoffs. Verbatim below.
