...
block_92:
    ...
    var_v0_526 = temp_s1_525;
loop_95:
    temp_v0_528 = (*(u8 *)((s8 *)(var_v0_526) + (2)));
    if (temp_v0_528 == 0) {
        goto block_97;
    }
    temp_a0_535 = temp_v0_528 * 0x34;
    var_s2_513 = D_80195560[temp_a0_535 + 0x12];
    memset_00023780(fill_base + temp_a0_535, 0x34);
block_97:
    var_s0_516 += 1;
    var_v0_526 = temp_s1_525 + var_s0_516;
    if (var_s0_516 < 5U) {
        goto loop_95;
    }
