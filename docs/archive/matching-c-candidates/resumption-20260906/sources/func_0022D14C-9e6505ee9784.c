    ...
    if (packet.words[3] > 0) {
        ...
        do {
            ...
            if (temp_a0_429 < 0x14) {
                ...
                func_00237D5C(temp_a0_429, &spD8, &spDC);
                var_v0_433 = func_0020D770(spD8, spDC);
            }
...
block_97:
    ...
    if (temp_a0_616 >= 0x2F) {
        ...
        func_00237D5C(temp_a0_616, &spE0, &spE4);
        temp_s0_635 = func_0020D770(spE0, spE4);
            ...
            if (var_s3_51 != 0) {
                if (func_0020C2C0(var_s3_51) != 0) {
                    ...
                    if (packet.bytes[4] == 8) {
                        ...
                        if (var_s1_844 != 0) {
                            var_s1_844 = func_002379AC(spE8, var_s3_51);
                        }
                    }
                    ...
                    if (packet.bytes[1] == 1) {
                        if (var_s2_802 != 0) {
                            ...
                            if ((sp1E4 != 0) && (func_0020C2C0(var_s3_51) == 0) && (func_0020C32C(var_s3_51) == 0)) {
                                ...
                                if (var_s1_844 != 0) {
                                    func_0022B06C(var_s3_51, &spE8);
                                }
                                func_0021D334(0x1F, temp_s7_700 + buffer[0], var_s3_51, 0, (s32)sp1BC >> 8, ((u8)sp1BC), sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), var_s1_844 ? spE8 : 0);
                            }
                        } else {
                        ...
                        func_0022B06C(var_s3_51, &spE8);
                        func_0021D334(0x1F, temp_s7_700 + buffer[0], var_s3_51, 2, (s32)sp1BC >> 8, ((u8)sp1BC), sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), spE8);
                        (*(s32 *)((s8 *)(var_s3_51) + (0x94))) = (s32) (temp_s7_700 + buffer[0]);
                        break;
                        ...
                        func_0021D334(0x1F, var_a1_1205, var_s3_51, var_a3_1183, 0, 0, sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), var_a3_1183 == 0xF ? 0xD : (var_a3_1183 == 6 ? 0 : (var_s1_844 ? spE8 : 0)));
...
block_249:
                            func_0021D334(0x1F, temp_s7_700 + buffer[0], var_s3_51, 6, 0, 0, sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), spE8);
                            (*(s32 *)((s8 *)var_s3_51 + 0x94)) = temp_s7_700 + buffer[0];
                            break;
                        }
                        func_0021D334(0x1F, var_a1_1205, var_s3_51, var_a3_1183, 0, 0, sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), var_a3_1183 == 0xF ? 0xD : (var_a3_1183 == 6 ? 0 : (var_s1_844 ? spE8 : 0)));
                        ...
                        if (var_s2_802 != 0) {
                            ...
                            if (temp_v0_1409 != 0) {
                                ...
                                func_0021D334(0x1F, temp_s7_700 + buffer[0], var_s3_51, 0xB, 0, 0, sp1F4, (s32) (*(u8 *)((s8 *)(*(void **)0x801CE8C0) + (0x823))), var_s1_844 ? spE8 : 0);
                            }
                            (*(s32 *)((s8 *)(var_s3_51) + (0x94))) = (s32) (temp_s7_700 + buffer[0]);
...
loop_241:
    ...
    for (var_s5_1662 = 0; var_s5_1662 < packet.words[3]; var_s5_1662++) {
        ids[var_a2_1641] = packet.words[4 + var_s5_1662];
        effects[var_a2_1641] = packet.bytes[116 + var_s5_1662];
        var_a2_1641++;
    }
