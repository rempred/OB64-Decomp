            ...
            if ((sp94 - 1) > 0) {
                ...
                do {
                    if (func_0020C32C(temp_v0_169) != 0) {
                        offsetCarrier = (u32)var_s1_639 | 0x50;
                        offsetCarrier &= 0x50;
                        func_0021D230(0x2D, temp_s5_640 + (*(s32 *)((s8 *)(var_s0_642) + offsetCarrier)), temp_v0_169, 0xFFU);
                        var_s3_641++;
                    } else {
                        offsetCarrier = (u32)var_s0_642 | 0x50;
                        offsetCarrier &= 0x50;
                        func_0021D25C(0x1D, temp_s5_640 + (*(s32 *)((s8 *)(var_s0_642) + offsetCarrier)), temp_v0_169, 0xFF, 0x11);
                        offsetCarrier = (u32)var_s1_639 | 0x50;
                        offsetCarrier &= 0x50;
                        temp_v1_665 = (*(s32 *)((s8 *)(var_s0_642) + offsetCarrier));
                    ...
                    var_s1_639 += 1;
                    var_s0_642 += 4;
                    boundCarrier = (u32)sp94 | (u32)var_s1_639;
                    boundCarrier &= (u32)sp94;
                } while (var_s1_639 < ((s32)boundCarrier - 1));
            }
            if (spDC != 0) {
                if (func_0020BFE4() != 0) {
...
block_149:
        ...
        if (func_0020BFE4() != 0) {
            ...
            tailTime = temp_s6_230 + var_s8_30 + sp9C;
            var_v0_923 = 0xB;
            if ((*(s32 *)((s8 *)(arg0) + (0x4C))) == 0x4A) {
                var_v0_923 = 7;
            }
            func_0021D25C(8, tailTime, arg0, 0xFF, var_v0_923);
