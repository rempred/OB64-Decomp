...
s32 func_0020C310(void *arg0);
s32 func_0020C348(void *arg0);

s32 func_0022EC08(void *arg0, s32 *arg1)
{
    s32 time;
    s32 current;
    u32 loaded;
    ...
    *(s32 *)((u8 *)arg0 + 0x6C) += 1;
    ...
    if (chance >= ((((random0 << 18) & 0x0C000000U) |
        ...
        func_0021D230(0x1B, time, arg0, 0xFF);
        *(s32 *)((u8 *)arg0 + 0x40) &= ~8;
        time += func_0022257C((u8 *)*(void **)arg0 + 0x44, 0x21, 0);
        if (func_0020C310(arg0) != 0) {
            func_0021D230(0x25, time, arg0, 0xFF);
            time += func_0022257C((u8 *)*(void **)arg0 + 0x44, 0x22, 0);
        } else if (func_0020C348(arg0) != 0) {
