...
void func_002159D0(void) {
    ...
    temp_s0_22 = func_80070F30(0x6094);
    temp_a1_25 = temp_s0_22;
    *(s32 *)(D_801CE8C0 + 0x814) = 0;
    func_00023460(D_801CE8BC, temp_a1_25, 0x6094);
...
loop_5:
    ...
    if ((u8) (*(u8 *)((s8 *)(temp_v0_83) + (0x819))) < (u8) (*(u8 *)((s8 *)(temp_a2_84) + (0x11)))) {
        goto block_7;
    }
    var_s2_17 = -1;
    goto block_23;
...
block_15:
    goto block_20;
block_17:
    if (temp_a1_87 != type_41) {
        goto block_20;
    }
    goto block_23;
block_19:
    temp_v1_114 = D_801CE8C0 + var_a0_75;
    (*(u8 *)((s8 *)(temp_v1_114) + (0x13))) = (u8) ((*(u8 *)((s8 *)(temp_v1_114) + (0x13))) + 4);
    goto block_23;
block_20:
...
block_22:
    *(s8 *)(D_801CE8C0 + var_a0_75 + 0x10) = type_38;
    D_801CE8C0[var_a0_75 + 0x13] = D_801E5C70[temp_a1_87];
block_23:
...
block_24:
    ...
    *(s8 *)(D_801CE8C0 + var_s2_17 + 0x10) = type_41;
    temp_v0_157 = D_801CE8C0;
    (*(u8 *)((s8 *)((temp_v0_157 + var_s2_17)) + (0x11))) = (u8) (*(u8 *)((s8 *)(temp_v0_157) + (0x819)));
    temp_v1_162 = D_801CE8C0;
    if ((*(s32 *)((s8 *)(temp_v1_162) + (0x810))) == var_s2_17) {
        goto block_27;
    }
    (*(s8 *)((s8 *)((temp_v1_162 + var_s2_17)) + (0x12))) = 0;
block_27:
    temp_v0_169 = D_801CE8BC;
    var_v0_171 = temp_v0_169 + (*(u8 *)((s8 *)(temp_v0_169) + (0x6072)));
    var_v1_173 = 2;
    goto block_32;
block_28:
    if (func_0020BF7C() != 0) {
...
block_30:
    ...
    var_v0_171 = temp_v1_185 + (*(u8 *)((s8 *)(temp_v1_185) + (0x6072)));
    var_v1_173 = 9;
block_32:
    (*(s8 *)((s8 *)(var_v0_171) + (0x606E))) = var_v1_173;
    D_801CE8BC[0x6073] = 0;
