...
s32 func_800712C4(void *);
f32 func_001BC35C(s16, s16);
f32 func_8023D178(f32, f32);
...
loop_1:
    ...
    do {
        ...
        delta_x = *(f32 *)((s8 *)temp_a0_41 + 0x11C) - *(f32 *)((s8 *)temp_s0_29 + 0x11C);
        delta_z = *(f32 *)((s8 *)temp_a0_41 + 0x124) - *(f32 *)((s8 *)temp_s0_29 + 0x124);
        var_v1_60 = (s32)delta_x;
        if (var_v1_60 < 0) {
            var_v1_60 = -var_v1_60;
        }
        var_v0_68 = (s32)delta_z;
        if (var_v0_68 < 0) {
            var_v0_68 = -var_v0_68;
        }
    ...
    } while ((u32)(var_a2_34 & 0xFFFF) < 0x1CU);
    var_v0_77 = -1;
block_24:
